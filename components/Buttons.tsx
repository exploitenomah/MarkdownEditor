...
export const IconButton = ({ children, onClick, extraClasses, innerRef }: BtnProps) => {
...
export const BtnBasic = ({children, onClick, extraClasses, innerRef}:BtnProps) => {
...
export const ToggleBtn  = ({checked, handleChange, id}:toggleBtnProps ) => {
